 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Symfony2_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
    ...
    protected function processVariable(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
            ...
            if ($tokens[$var]['code'] === T_STRING) {
                ...
                if ($tokens[$bracket]['code'] !== T_OPEN_PARENTHESIS) {
                    ...
                    if (PHP_CodeSniffer::isCamelCaps($objVarName, false, true, false) === false) {
                        ...
                        // We can't do anything about this due to Active Record
                        /*
                        $error = 'Variable "%s" is not in valid camel caps format (2)';
        ...
        if (PHP_CodeSniffer::isCamelCaps($varName, false, true, false) === false) {
            $error = 'Variable "%s" is not in valid camel caps format (3)';
            $data  = array($originalVarName);
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (PHP_CodeSniffer::isCamelCaps($varName, false, true, true) === false) {
            ...
            if ((strpos($varName,"_") != false) || (strtolower($varName) != $varName))
            {
                $error = 'Member variable "%s" is not in valid camel caps format (1)';
                $data  = array($varName);
